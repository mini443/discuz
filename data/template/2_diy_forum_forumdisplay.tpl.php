...
0
|| checktplrefresh('./template/color_luntan199/forum/forumdisplay.htm', './template/default/forum/forumdisplay_leftside.htm', 1543263121, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/color_luntan199', 'forum/forumdisplay')
|| checktplrefresh('./template/color_luntan199/forum/forumdisplay.htm', './template/default/forum/recommend.htm', 1543263121, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/color_luntan199', 'forum/forumdisplay')
|| checktplrefresh('./template/color_luntan199/forum/forumdisplay.htm', './template/default/common/seccheck.htm', 1543263121, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/color_luntan199', 'forum/forumdisplay')
|| checktplrefresh('./template/color_luntan199/forum/forumdisplay.htm', './template/color_luntan199/forum/forumdisplay_list.htm', 1543263121, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/color_luntan199', 'forum/forumdisplay')
|| checktplrefresh('./template/color_luntan199/forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1543263121, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/color_luntan199', 'forum/forumdisplay')
|| checktplrefresh('./template/color_luntan199/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1543263121, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/color_luntan199', 'forum/forumdisplay')
|| checktplrefresh('./template/color_luntan199/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1543263121, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/color_luntan199', 'forum/forumdisplay')
...
<th class="<?php echo $thread['folder'];?>">
                          <div id="toux"><a href="home.php?mod=space&amp;uid=<?php echo $thread['authorid'];?>"><?php echo avatar($thread[authorid],small);?></a>
                          </div>
