...
0
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/header.htm', 1543573423, '2', './data/template/2_2_search_portal.tpl.php', './template/color_luntan199', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/pubsearch.htm', 1543573423, '2', './data/template/2_2_search_portal.tpl.php', './template/color_luntan199', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/portal_list.htm', 1543573423, '2', './data/template/2_2_search_portal.tpl.php', './template/color_luntan199', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/footer.htm', 1543573423, '2', './data/template/2_2_search_portal.tpl.php', './template/color_luntan199', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/common/header_common.htm', 1543573423, '2', './data/template/2_2_search_portal.tpl.php', './template/color_luntan199', 'search/portal')
;?>
