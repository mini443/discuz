...
0
|| checktplrefresh('./template/color_luntan199/common/header.htm', './template/default/common/header_common.htm', 1543263121, '2', './data/template/2_2_common_header_forum_forumdisplay.tpl.php', './template/color_luntan199', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/color_luntan199/common/header.htm', './template/default/common/header_qmenu.htm', 1543263121, '2', './data/template/2_2_common_header_forum_forumdisplay.tpl.php', './template/color_luntan199', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/color_luntan199/common/header.htm', './template/color_luntan199/common/pubsearchform.htm', 1543263121, '2', './data/template/2_2_common_header_forum_forumdisplay.tpl.php', './template/color_luntan199', 'common/header_forum_forumdisplay')
;?>
...
<div class="wpdh"><?php if(!empty($_G['setting']['pluginhooks']['global_header'])) echo $_G['setting']['pluginhooks']['global_header'];?></div>
<?php } ?>
