<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('discuz');?><?php include template('common/header'); ?>  
<div class="wpdh">
...
<div class="wpdh">
    ...
    <!--[diy=diyad2]--><div id="diyad2" class="area"></div><!--[/diy]-->
    <!--[diy=diyad3]--><div id="diyad3" class="area"></div><!--[/diy]-->
    </td>
    <td style=" width:320px;">
    <!--[diy=diyad4]--><div id="diyad4" class="area"></div><!--[/diy]-->
    </td>
    </tr>
    </table>
    ...
    <tr valign="top">
    <td class="zuozuo">
    <!--[diy=diy14]--><div id="diy14" class="area"></div><!--[/diy]-->
    </td>
    <td class="youyou">
...
<div class="bm lk" style=" width:100%; margin-bottom:12px;">
...
<ul class="x mbm cl" style="padding-bottom:10px;">
