...
// ----------------------------  CONFIG DB  ----------------------------- //
$_config['db']['1']['dbhost'] = '43.249.29.57';
$_config['db']['1']['dbuser'] = 'sanzu';
$_config['db']['1']['dbpw'] = '1qaz2wsx@#$%';
...
// --------------------------  CONFIG COOKIE  --------------------------- //
$_config['cookie']['cookiepre'] = 'ay2r_';
$_config['cookie']['cookiedomain'] = '';
$_config['cookie']['cookiepath'] = '/';

// -------------------------  CONFIG SECURITY  -------------------------- //
$_config['security']['authkey'] = '058fe0a15c47c9a96c4bd078c570e01eQsbKivYeloUzio0fqW';
